...
function GroupChatItem({item,index,userid, currentuserid,onEditMsg}){
            ...
            {msg.user._id != userid ?
                <VUView flexDirection="row" justifyContent="space-between">
                    <VUView
                        ...
                        <VUView justifyContent="space-between" bg={"#2C2B7E"} py={2} px={2} borderRadius={10} maxWidth={windowWidth - 50}>
                            {msg.type == "text" &&
                ...
                <VUTouchableOpacity onLongPress={onLongPressComment.bind(this, msg)}>
                    <VUView flexDirection="row" justifyContent="space-between">
                        ...
                        <VUView
                            ...
                            px={1}
                            m={'1px'}>
                            <VUView justifyContent="space-between" justifyContent="space-between" bg={AppStyles.color.primary} py={2} px={2} borderRadius={10} maxWidth={windowWidth - 50}>                        
                                {msg.type == "text" &&
                                    <VUText fontSize={14} color={AppStyles.color.white} mb={1}>
                                        {msg.text}
                                    </VUText>
...
export default memo(GroupChatItem);